...
def main(argv):
  ...
  for curb in range(1,nblocks+1):
    ...
    curjob = curjob + 'computeFeaturesCompiled/for_testing/run_computeFeaturesCompiled.sh' + ' ' + mcrpath + ' ' + moviename + ' '+ trxname + ' ' + stationary + ' deep-sup ' + str(curb) +' ' + str(blocksize) +' ' + curoutname + ';\n'
